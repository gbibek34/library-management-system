...
class borrowerEntry:
    def __init__(self, window):
        ...
        self.borrower_tbl.heading("bid", text="ID")
        self.borrower_tbl.heading("bname", text="Book Name")
        self.borrower_tbl.heading("bgenre", text="Genre")
        self.borrower_tbl.heading("bauthor", text="Author")
        self.borrower_tbl.heading("availability", text="Availability")
        self.borrower_tbl['show'] = 'headings'
        self.borrower_tbl.column("bid", width=5)
        self.borrower_tbl.column("bname", width=150)
        self.borrower_tbl.column("bgenre", width=40)
        self.borrower_tbl.column("bauthor", width=80)
        self.borrower_tbl.column("availability", width=10)
